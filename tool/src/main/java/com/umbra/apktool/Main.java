...
/**
 * Created by zhangweiding on 16/3/18.
 */
public class Main {
    ...
    public static void main(String[] args) {
       String[] vals = new String[]{"-f","app-release.apk","-t","app-release.apk","-o","test","-k","baidu.store","-p","123456","-a","baidu","-e","123456"};

        CommandLineParser parser = new PosixParser();
        CommandLine commandLine = null;
        option();
        try {
            commandLine = parser.parse(allOptions, vals,true);
    ...
    private static void option()
    {
        ...
        OptionBuilder.withDescription("old Apk file path."); OptionBuilder.hasArg(true);
        OptionBuilder.withArgName("loc");
        ...
        OptionBuilder.withDescription("keystore path."); OptionBuilder.hasArg(true);
        OptionBuilder.withArgName("loc");
        ...
        OptionBuilder.withDescription("keystore password."); OptionBuilder.hasArg(true);
        ...
        OptionBuilder.withDescription("alias."); OptionBuilder.hasArg(true); OptionBuilder.withArgName("alias");
        ...
        OptionBuilder.withDescription("entry password."); OptionBuilder.hasArg(true);
        OptionBuilder.withArgName("***");
        ...
        OptionBuilder.withDescription("output dir."); OptionBuilder.hasArg(true); OptionBuilder.withArgName("dir");
        ...
        OptionBuilder.withDescription("patch name."); OptionBuilder.hasArg(true);
